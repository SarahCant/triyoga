        ...
        <div className="border-x-8 border-[color:--main] md:mx-20">
          ...
          <div className="bg-[color:#F9DDC3] p-2 border-x-8 border-[color:#769975]">
            <p className="leading-7">
              ...
              tilmelde dig. For at tilmelde dig et bestemt hold, skal du trykke
              på “Book” knappen på dette hold. Herefter skal du oprette dig som
              bruger eller logge ind. Så bliver du ført til den endelige
              bookingside. Du kan læse mere om de enkelte tilbud ved at trykke
              på &quot;Læs&quot;.
            </p>
            {/* icon section */}
